...
<h1><strong>Liquor-free Madhya Pradesh</strong></h1>
                            <br><h1>शराब मुक्त मध्य प्रदेश</h1>                                                        <div class="description">
                            	<p>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left" style="width: 80%;">
                        			<h3 style="color:#0C0;font-weight:bold;font-size:53px;padding:10px;">Thank You</h3>
                            		<p style="color:#0C0;font-size:25px;font-weight:bold;">Thank you for your participation.</p>
                        		</div>
